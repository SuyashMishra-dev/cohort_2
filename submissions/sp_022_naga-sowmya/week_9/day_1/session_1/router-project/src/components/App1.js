            ...
            <React.Fragment>
                <BrowserRouter>
                    <nav className="container navbar navbar-expand-lg navbar-light bg-transparent">
                        <a className="navbar-brand" style={{color: "#00897B", fontFamily : "'Turret Road', cursive", fontWeight:"bold", fontSize:40}}>PROPER</a>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <Link to='/products/asc' className="nav-link" href="#">Products</Link>
                                </li>
                            </ul>
                        </div>
                        <form>
