        ...
        <div className="mt-3 container">
            <div className="card">
                ...
                <div className="card-img-overlay">
                    <h2 className="card-title text-left" style={{color:"black"}}>Our Mission</h2>
                    <h5 className="card-text text-black-60 text-left" style={{color:"black"}}>Proper technology experiences.</h5>
                </div>
            </div>
