...
1. Inherited
```
color, background-color, display, float, font-weight, display, visibility,word-wrap,  clear
```
2. Non-Inherited
```
font-size, padding, margin, border, text-align, height, width, overflow, z-index, position, overflow
```
