...
import { incrementCounter, decrementCounter, multiplyCounter,divideCounter ,remainderCounter, incrementCounterOne, incrementCounterTwo} from "./Action";
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => store.dispatch(incrementCounterOne(Number(inputValue)))}>
      Increment count by x+1
      </button>
      <button onClick={() => store.dispatch(incrementCounterTwo(Number(inputValue)))}>
