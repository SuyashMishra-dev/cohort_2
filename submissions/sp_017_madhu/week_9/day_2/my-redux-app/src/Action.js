...
const incrementCounterTwo =amount =>{
  return{
    type: INCREMENT_ONE,
    amount
  };
...
const incrementCounterOne= amount =>{
  return{
    type: INCREMENT_TWO,
    amount
  };
...
export { incrementCounter, decrementCounter , multiplyCounter, divideCounter, remainderCounter, incrementCounterTwo,incrementCounterOne};
