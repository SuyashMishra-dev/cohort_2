...
1. Inherited
```
color,text-align,font-size,display,text-align,font-weight,visibility,word-wrap
```
2. Non-Inherited
```
border,padding,margin,background-color,border,float,width,height,overflow-index,position,clear
```
