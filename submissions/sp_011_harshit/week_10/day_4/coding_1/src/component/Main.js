        ...
        return (
            <div>
                <div style={{ width: "500px",  marginTop: "30px" }}>
                    <input id={"input"} style={{ fontSize: "30px", height: "50px" }} value={this.state.value}></input>
                ...
                <div style={{ marginTop: "20px" }}>
                    ...
                    <div className="flex">
                        ...
                        <button onClick={() => this.handleClick("+")} style={{  fontSize: "50px", backgroundColor: "grey", color: "white" }}>+</button>
                    </div>
                    <div className="flex">
                    ...
                    <div className="flex">
                        ...
                        <button onClick={() => this.handleClick("x")} style={{ fontSize: "50px", backgroundColor: "grey", color: "white" }}>x</button>
                    </div>
                    <div className="flex">

                        <button onClick={() => this.handleClick("=")} style={{ fontSize: "50px", backgroundColor: "grey", color: "white" }}>=</button>
                        <button onClick={() => this.handleClick(0)}>0</button>
                        <button onClick={() => this.handleClick("del")} style={{  fontSize: "30px", backgroundColor: "grey", color: "white" }}>DEL</button>
                        <button onClick={() => this.handleClick("/")} style={{ fontSize: "50px", backgroundColor: "grey", color: "white" }}>/</button>
                    </div>

                    <div className="flex">
                        <button id={"1"} style={{ width: "430px" }} onClick={() => this.flagset()}>History</button>
                    </div>
