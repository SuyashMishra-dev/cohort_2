...
1. Inherited
```
color, font-size,test-align,fornt-weight,word-wrap,visibility
```
2. Non-Inherited
```
padding,margin,background-color,border,display,float,display,heigh,width,overflow,
z-index, position,clear
```
